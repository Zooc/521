...
/**
 * @description: {@link com.google.android.exoplayer2.ui.PlaybackControlView} 注释了hide方法
 * @author: Kenny
 * @date: 2017-09-05 15:27
 * @version: 1.0
 */

public class PlayCtrlView extends FrameLayout {
    ...
    public PlayCtrlView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PlayCtrlView(Context context, AttributeSet attrs, int defStyleAttr) {
